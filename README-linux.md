...
code --install-extension "devzstudio.emoji-snippets" --force  
...
code --install-extension "PulkitGangwar.nextjs-snippets" --force  
...
code --install-extension "Thinker.create-app" --force  
